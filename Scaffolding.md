...
| 구분 | 결정 | 언제까지 잠그나 |
|---|---|---|
| **본체** | **D1~D12 · D14** (13개) | **7/27까지.** 이 13개가 모두 잠기기 전에는 Step 1 이후로 넘어가지 않는다 |
...
**Step 0 산출물** — 분석 사양서 1개 + `DECISIONS.md` 항목 13건 (D13은 킥오프 후 추가)
**Step 0 통과 기준** — D1~D12·D14에 빈칸이 없고, 각 항목에 근거와 출처가 있음
...
|---|---|---|---|---|
| **0. 결정 잠금** | §2의 D1~D12·D14를 확정한다 | — | 분석 사양서 · `DECISIONS.md` | 빈칸 없음, 각 결정에 근거 있음 |
...
| **6. 비즈니스 문서** | Decision Card를 1페이지 문서로 바꾼다 | D9 · **D14** | CEO Decision Card · 브리핑 | 한 페이지 · D14가 정한 필수 항목 전부 충족 |
...
| 시점 | 하는 일 |
|---|---|
| ~7/27 | **Step 0(D1~D12·D14 잠금) → Step 1 → 2 → 3 → 4 → 5a**까지 끝낸다 |
...
- **Step 0의 결정 D1~D12·D14는 각각 별도 Issue**로 만든다. 결정 하나 = Issue 하나 = PR 하나여야 근거가 추적된다.
